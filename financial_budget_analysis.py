...
Original file is located at
    https://colab.research.google.com/drive/1Kp4sCBvJAggy7XyX6MI4maHWmFjgQrjI
...
data = pd.read_csv("/content/India_budget_2021[1].csv")
data.head()
...
"""# Plotting the data into donut plot
